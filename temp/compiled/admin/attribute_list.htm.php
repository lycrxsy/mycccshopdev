...
?>
    <tr>
      ...
      <td align="center" nowrap="true" valign="top">
        <a href="?act=edit&amp;attr_id=<?php echo $this->_var['attr']['attr_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="21" width="21"></a>
        <a href="javascript:;" onclick="removeRow(<?php echo $this->_var['attr']['attr_id']; ?>)" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21"></a>
      </td>
    </tr>
    <?php endforeach; else: ?>
