...
?>
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td> <a href="sms.php?act=display_send_ui&mobile=<?php echo $this->_var['address']['mobile']; ?> "><?php echo htmlspecialchars($this->_var['address']['mobile']); ?></a> </td>
    </tr>
  </table>
...
<?php if ($this->_var['order']['invoice_no'] && $this->_var['order']['shipping_time'] != '未发货'): ?>
  <tr>
    <th colspan="4">物流信息跟踪</th>
  </tr>
  <tr>
    <td colspan="4"><div id="retData"></div></td>
  </tr>
<?php endif; ?>
  <tr>
  ...
  <tr>
    ...
    <td><a href="sms.php?act=display_send_ui&mobile=<?php echo $this->_var['order']['mobile']; ?> "><font color="red"><?php echo htmlspecialchars($this->_var['order']['mobile']); ?></font></a></td>
  </tr>
  <tr>
