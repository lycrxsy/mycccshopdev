...
<div class="login_box">
<div class="login_con">
<div class="login_logo"><a href="http://www.ccc-global.com/" target="_blank"><img src="images/logo.png" class="img-circle"/></a></div>
...
<form method="post" action="privilege.php" name='theForm' onsubmit="return validate()">
  <table cellspacing="0" cellpadding="0" border="0" align="center" width="320">
    <tr>
      <td height="70" align="center" valign="middle" style="font-size:30px; color:#333; font-family:'微软雅黑';">MyCCCShop 管理中心</td>
    </tr>
    <tr>
      <td align="center" >
      	<table>
