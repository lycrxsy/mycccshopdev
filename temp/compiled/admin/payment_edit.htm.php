...
?>
  <tr>
    <td class="label">
      ...
      <a href="javascript:showNotice('notice<?php echo $this->_var['config']['name']; ?>');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a>
      <?php endif; ?>
