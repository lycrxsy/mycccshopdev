...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_img'); ">商品图片</a></th>
...
?>
  <tr>
    ...
    <td><a href="../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="../<?php echo $this->_var['goods']['goods_thumb']; ?>" width="50"/></a></td>
    ...
    <td align="center">
      ...
      <?php if ($this->_var['specifications'] [ $this->_var['goods']['goods_type'] ] != ''): ?><a href="goods.php?act=product_list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['item_list']; ?>"><img src="images/icon_docs.gif" width="21" height="21" border="0" /></a><?php else: ?><img src="images/empty.gif" width="1" height="1" border="0" /><?php endif; ?>
      <?php if ($this->_var['specifications'] [ $this->_var['goods']['goods_type'] ] != ''): ?><a href="product_spec_pic.php?act=list&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['specification_pic']; ?>"><img src="images/guigou_icon.png" width="21" height="21" border="0" /></a><?php else: ?><img src="images/empty.gif" width="21" height="21" border="0" /><?php endif; ?>
