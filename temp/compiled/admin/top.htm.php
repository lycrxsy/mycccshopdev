  ...
  <div class="submenu-div">
   ...
   <?php echo $this->_var['lang']['signout']; ?></a></li>
     ...
     <li><a href="index.php?act=clear_cache" target="main-frame" class="fix-submenu"><img src="images/qingchu.png" style="border:none;"/><span><?php echo $this->_var['lang']['clear_cache']; ?></span></a></li>
      ...
      <li style="width:102px;border-left:none;"><a href="http://www.ccc-global.com" target="main-frame" style="border:none;"><img src="images/topmune_09.png" style="border:none;"/><span>公司介绍</span></a></li>
    </ul>
