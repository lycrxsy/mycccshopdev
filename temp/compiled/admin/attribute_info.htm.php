...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        <td class="label"><a href="javascript:showNotice('noticeindex');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['label_attr_index']; ?></td>
        <td>
    ...
    <tr>
        <td class="label"><a href="javascript:showNotice('noticeAttrType');" title="<?php echo $this->_var['lang']['form_notice']; ?>"><img src="images/notice.gif" width="21" height="21" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php echo $this->_var['lang']['label_attr_type']; ?></td>
        <td>
