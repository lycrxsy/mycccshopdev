...
?>
  <div class="z-com cle">
    <div class="z-com-left"> <img class="face_img" src="themes/MyCCCShop201803/images/default_45.png"> <span class="u-name"><?php if ($this->_var['comment']['username']): ?><?php echo htmlspecialchars($this->_var['comment']['username']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></span> </div>
      ...
      <div class="z-coms" id="comment_id_1329143">
        ...
        <div class="z-com-hf">
          ...
          <div class="hf_list">
            <ul>
              <li>
                <div class="cle hf_list_li"><span class="hf_face"><img class="face_img" src="themes/MyCCCShop201803/images/default_45.png"></span><span class="hf_text"> <em class="hf_name"><?php echo $this->_var['lang']['admin_username']; ?></em><em class="hf_name">：</em><?php echo $this->_var['comment']['re_content']; ?></span></div>
              </li>
            </ul>
          </div>
        </div>
    ...
    <span style="position:absolute; right:10px; top:5px; font-size:24px; cursor:pointer;" onClick="easyDialog.close();">×</span>
      <li>
       ...
       <input name="comment_rank" type="radio" value="1" id="comment_rank1" />
          <img src="themes/MyCCCShop201803/images/stars1.gif" />
          <input name="comment_rank" type="radio" value="2" id="comment_rank2" />
          <img src="themes/MyCCCShop201803/images/stars2.gif" />
          <input name="comment_rank" type="radio" value="3" id="comment_rank3" />
          <img src="themes/MyCCCShop201803/images/stars3.gif" />
          <input name="comment_rank" type="radio" value="4" id="comment_rank4" />
          <img src="themes/MyCCCShop201803/images/stars4.gif" />
          <input name="comment_rank" type="radio" value="5" checked="checked" id="comment_rank5" />
          <img src="themes/MyCCCShop201803/images/stars5.gif" />
      </li>
            <li>
