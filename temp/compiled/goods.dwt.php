...
<link href="themes/MyCCCShop201803/goods.css" rel="stylesheet" type="text/css" />
<link href="themes/MyCCCShop201803/quick_buy.css" rel="stylesheet" type="text/css" />
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
		...
		<div class="skunum" id="skunum">
             ...
             <cite class="storage">(<font id="shows_number">&#25240;&#47;&#32764;&#42;&#22825;&#47;&#20351;&#42;&#36164;&#47;&#28304;&#42;&#31038;&#47;&#21306;&#42;&#25552;&#47;&#20379;</font>)</cite>
              <?php endif; ?> 
		</div>
              </li>
...
?>
	...
	<?php echo $this->fetch('library/comments.lbi'); ?>
	  ...
	  <div class="z-detail-right">
	  	...
	  	<div class="hot_box">
			<ul>
				<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_93541400_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_93541400_1522073708']):
?>
				<li>
					<a href="<?php echo $this->_var['goods_0_93541400_1522073708']['url']; ?>" target="_self">
						<img width="194px" height="194px" src="<?php echo $this->_var['goods_0_93541400_1522073708']['thumb']; ?>" />
						<p><?php echo $this->_var['goods_0_93541400_1522073708']['short_style_name']; ?></p>
						<p class="hot_price">
							<?php if ($this->_var['goods_0_93541400_1522073708']['promote_price'] != ""): ?>
          					<?php echo $this->_var['goods_0_93541400_1522073708']['promote_price']; ?>
          					<?php else: ?>
          					<?php echo $this->_var['goods_0_93541400_1522073708']['shop_price']; ?>
          					<?php endif; ?>
						</p>
					</a>
				</li>
