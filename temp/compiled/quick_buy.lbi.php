        ...
        <div class="quickBox clearfix">
          <form action="quick_buy.php" method="post" name="ECS_FORMQUICKBUY" id="ECS_FORMQUICKBUY" onsubmit="return checkOrderForm(this)">
            ...
            <ul class="QuickProductBox clearfix">
              ...
              <?php $_from = $this->_var['specification']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('spec_key', 'spec_0_96545900_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['spec_key'] => $this->_var['spec_0_96545900_1522073708']):
?>
              <li> <em><?php echo $this->_var['spec_0_96545900_1522073708']['name']; ?>：</em>
                
                <?php if ($this->_var['spec_0_96545900_1522073708']['attr_type'] == 1): ?>
                <?php if ($this->_var['cfg']['goodsattr_style'] == 1): ?>
				<div class="sku_box2">
				 <?php $_from = $this->_var['spec_0_96545900_1522073708']['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'value_0_96566200_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['value_0_96566200_1522073708']):
?>
                <label class="<?php if ($this->_var['key'] == 0): ?>selected<?php endif; ?> sku_list2" for="spec_quick_value_<?php echo $this->_var['value_0_96566200_1522073708']['id']; ?>">
                  <input style="display:none;" type="radio" name="spec_quick_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value_0_96566200_1522073708']['id']; ?>" id="spec_quick_value_<?php echo $this->_var['value_0_96566200_1522073708']['id']; ?>" <?php if ($this->_var['key'] == 0): ?>checked<?php endif; ?> onclick="quick_to_cart(<?php echo $this->_var['goods']['goods_id']; ?>)" />
                  <?php echo $this->_var['value_0_96566200_1522073708']['label']; ?> <span class="icon_bg">已选中</span></label>
                ...
                <select name="spec_quick_<?php echo $this->_var['spec_key']; ?>" onchange="quick_to_cart(<?php echo $this->_var['goods']['goods_id']; ?>)">
                  <?php $_from = $this->_var['spec_0_96545900_1522073708']['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'value_0_96597200_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['value_0_96597200_1522073708']):
?>
                  <option label="<?php echo $this->_var['value_0_96597200_1522073708']['label']; ?>" value="<?php echo $this->_var['value_0_96597200_1522073708']['id']; ?>"><?php echo $this->_var['value_0_96597200_1522073708']['label']; ?> <?php if ($this->_var['value_0_96597200_1522073708']['price'] > 0): ?><?php echo $this->_var['lang']['plus']; ?><?php elseif ($this->_var['value_0_96597200_1522073708']['price'] < 0): ?><?php echo $this->_var['lang']['minus']; ?><?php endif; ?><?php if ($this->_var['value_0_96597200_1522073708']['price'] != 0): ?><?php echo $this->_var['value_0_96597200_1522073708']['format_price']; ?><?php endif; ?></option>
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </select>
                <input type="hidden" name="spec_list" value="<?php echo $this->_var['key']; ?>" />
                <?php endif; ?>
                <?php else: ?>
                <?php $_from = $this->_var['spec_0_96545900_1522073708']['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'value_0_96630600_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['value_0_96630600_1522073708']):
?>
                <label for="spec_quick_value_<?php echo $this->_var['value_0_96630600_1522073708']['id']; ?>">
                  <input type="checkbox" name="spec_quick_<?php echo $this->_var['spec_key']; ?>" value="<?php echo $this->_var['value_0_96630600_1522073708']['id']; ?>" id="spec_quick_value_<?php echo $this->_var['value_0_96630600_1522073708']['id']; ?>" onclick="quick_to_cart(<?php echo $this->_var['goods']['goods_id']; ?>)" />
                  <?php echo $this->_var['value_0_96630600_1522073708']['label']; ?> [<?php if ($this->_var['value_0_96630600_1522073708']['price'] > 0): ?><?php echo $this->_var['lang']['plus']; ?><?php elseif ($this->_var['value_0_96630600_1522073708']['price'] < 0): ?><?php echo $this->_var['lang']['minus']; ?><?php endif; ?> <?php echo $this->_var['value_0_96630600_1522073708']['format_price']; ?>] </label>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <input type="hidden" name="spec_list" value="<?php echo $this->_var['key']; ?>" />
                <?php endif; ?>
              </li>
...
?>
            ...
            <ul class="quickAddressBox clearfix">
              <li style="clear:both"> <em>&nbsp;</em>
                <input type="image" src="themes/MyCCCShop201803/images/zt_cart_bg05.jpg" value="" style="cursor:pointer; border:0px;" />
              </li>
            </ul>
          </form>
        </div>
...
<?php $_from = $this->_var['lang1']['flow_js']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_96771400_1522073708');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_96771400_1522073708']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_96771400_1522073708']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
