...
<link href="themes/MyCCCShop201803/login.css" rel="stylesheet" type="text/css" />
...
?>
    ...
    <ul class="topbar-nav fr">
      <li><i class="i-global i-topbar-order"></i><a href="javascript:myOrderList();" rel="nofollow">我的订单</a></li>
      <li class="tb-qrcode relative"><i class="i-global i-topbar-download"></i><a title="他趣APP官方下载地址" href="http://app.taqu.cn/" target="_blank">下载APP</a><i class="qrcode qrcode-tb hide"></i></li>
      <li><i class="i-global i-topbar-favorites"></i><a href="javascript:addFavorite('他趣商城',location.href);" rel="nofollow">收藏本站</a></li>
      ...
      <li><i class="i-global i-topbar-phone"></i><?php echo $this->_var['shop_name']; ?>服务热线：<?php echo $this->_var['service_phone']; ?></li>
    </ul>
  </div>
...
<div class="login_midlle">
    ...
    <div class="logo fl">
    <a href="/">
    <img src="themes/MyCCCShop201803/images/logo.gif">
    </a>
    </div>
        <div class="login_character fl"> 欢迎登录 </div>
        <div class="login-guarantee fr">
        <img src="http://static.taqu.cn/img/login-guarantee.png" alt="正品低价 绝对隐私 安全材质 质量保证">
        </div>
    </div>
</div>
<script>
...
?> 
	...
	<?php elseif ($this->_var['field']['reg_field_name'] == '手机'): ?>
		<?php if ($this->_var['_CFG'] [ 'ecsdxt_mobile_reg' ] == '1'): ?>
			...
			<li class="input_box sms_button"><input class="sms_button_titel" type="button" onclick="getverifycode1('extend_field<?php echo $this->_var['field']['id']; ?>', '<?php echo $this->_var['field']['reg_field_name']; ?>');" value="获取验证码" id="zphone"></li>
