...
?>          
  ...
  <div class="wrap clf">
    <div class="logo fl">
      <a href="index.php" title="<?php echo $this->_var['shop_name']; ?>"><img src="themes/MyCCCShop201803/images/logo.gif" alt="<?php echo $this->_var['shop_name']; ?>"></a>
  </div>
...
<?php $_from = cat_hot_list(1,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
<li><a target="_blank" href="<?php echo $this->_var['hot']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['hot']['name']); ?>">
<p class="submenu-hot-sale-pic">
<img src="<?php echo $this->_var['hot']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['hot']['name']); ?>" style="display: inline;">
</p><?php echo htmlspecialchars($this->_var['hot']['name']); ?></a>
</li>
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>  
<?php elseif ($this->_var['cat']['id'] == 2): ?>
<?php $_from = cat_hot_list(2,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>        
<?php elseif ($this->_var['cat']['id'] == 3): ?>
<?php $_from = cat_hot_list(3,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>        
<?php elseif ($this->_var['cat']['id'] == 4): ?>
<?php $_from = cat_hot_list(4,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>        
<?php elseif ($this->_var['cat']['id'] == 5): ?>
<?php $_from = cat_hot_list(5,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>        
<?php elseif ($this->_var['cat']['id'] == 6): ?>
<?php $_from = cat_hot_list(6,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>   
<?php elseif ($this->_var['cat']['id'] == 7): ?>
<?php $_from = cat_hot_list(7,8); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'hot');$this->_foreach['hots'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['hots']['total'] > 0):
    foreach ($_from AS $this->_var['hot']):
        $this->_foreach['hots']['iteration']++;
?>
