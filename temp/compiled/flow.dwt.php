...
<link href="themes/MyCCCShop201803/cart.css" rel="stylesheet" type="text/css" />
...
<div class="p_l">
<div class="logo">
<a href="index.php" title="<?php echo $this->_var['shop_name']; ?>">
<img src="themes/MyCCCShop201803/images/logo.gif" alt="<?php echo $this->_var['shop_name']; ?>">
</a>
</div>
<div class="login_character fl">购物车</div>
</div>
<div class="p_r">
<div class="page_step">
...
<ul class="title">
<li <?php if ($this->_var['step'] == "cart"): ?>class="step_1"<?php endif; ?>>我的购物车</li>
<li <?php if ($this->_var['step'] == "checkout"): ?>class="step_2"<?php endif; ?>>确认订单信息</li>
<li <?php if ($this->_var['step'] == "done"): ?>class="step_3"<?php endif; ?>>成功提交订单</li>
</ul>
</div>
</div>
</div>
...
?>
        <li class="cle hover" style="border-bottom-style: none;"> 
          ...
          <div class="pic"> <img src="themes/MyCCCShop201803/images/czlb.png"></div>
...
?> 
          ...
          <?php else: ?>
          <div class="pic"> <img src="themes/MyCCCShop201803/images/yhcx.png"></div>
...
?>
        ...
        <div class="flowBox">
          ...
          <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/MyCCCShop201803/images/bnt_subOrder.gif" />
