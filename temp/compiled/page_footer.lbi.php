...
<?php if ($this->_var['icp_number']): ?>
  ...
  <?php endif; ?>
        ...
        <ul class="copyright-nav fl">
         ...
         <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_85423300_1523222150');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_85423300_1523222150']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
       <li><a href="<?php echo $this->_var['nav_0_85423300_1523222150']['url']; ?>" <?php if ($this->_var['nav_0_85423300_1523222150']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_85423300_1523222150']['name']; ?></a></li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      <?php endif; ?>
      </ul>
      </div>
