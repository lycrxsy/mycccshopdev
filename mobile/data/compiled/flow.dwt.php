...
<section class="wrap"  >
  <div class="empty-cart">
    ...
    <div class="flex"> <a class="c-btn2  flex_in radius5" href="index.php" style=" background:#454c5f;"> <i class="ico_04_b"></i> 去购物 </a> <a class="c-btn2  flex_in radius5" href="user.php?act=collection_list" style=" margin-left:0.5rem"> 查看收藏夹</a> </div>
  </div>
</section>
<?php endif; ?> 
...
?>
		...
		<div class="dl_box" id="inviype_box" style="margin-bottom:0.5rem; display:none;">
                <dl style="line-height: 40px;">
                    ...
                    <dd>
		    <input name="need_inv" type="checkbox" id="ECS_NEEDINV" value="1" checked="true" style="display:none;" />
