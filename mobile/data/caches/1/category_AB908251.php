<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:55:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/category.dwt";i:1;s:65:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/library/goods_list.lbi";i:2;s:66:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1522069447;s:8:"maketime";i:1522065847;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>个护、美妆类小类4_个护、美妆类_MyCCCShop-专注于德国货源供应！ 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <div class="categoryleve clearfix"><span>分类：</span>
									<a  href="category.php?id=11">个护、美妆类小类1</a>
							<a  href="category.php?id=14">个护、美妆类小类2</a>
							<a  href="category.php?id=15">个护、美妆类小类3</a>
							<a  class="current" href="category.php?id=10">个护、美妆类小类4</a>
							<a  href="category.php?id=16">个护、美妆类小类5</a>
							<a  href="category.php?id=9">个护、美妆类小类6</a>
					</div>
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb f-ico-triangle-slctd"></i> </span> </a> </li>
      <li class=""> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      ...
      <li class="filter-cur"> <a href="category.php?category=10&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=10&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/default/images/loader.gif" /></div>'})
	$(window).scroll(function () {
