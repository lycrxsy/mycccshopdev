<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:58:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/article_cat.dwt";i:1;s:60:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/library/pages.lbi";i:2;s:66:"C:/WEB/MyCCCShop/Syy/mobile/themes/default/library/page_footer.lbi";}s:7:"expires";i:1522021056;s:8:"maketime";i:1522017456;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>网店帮助分类_系统分类_MyCCCShop-专注于德国货源供应！ 触屏版</title>
...
<section class="wrap">
  <div class="list_box padd1 radius10" style="padding-top:0;padding-bottom:0;"> 
    ...
    <a href="article.php?id=17" class="clearfix"> <span>支付方式说明</span><i></i> </a> 
     
    <a href="article.php?id=16" class="clearfix"> <span>配送支付智能查询</span><i></i> </a> 
     
    <a href="article.php?id=15" class="clearfix"> <span>货到付款区域</span><i></i> </a> 
     
    <a href="article.php?id=11" class="clearfix"> <span>订购方式</span><i></i> </a> 
     
    <a href="article.php?id=10" class="clearfix"> <span>购物流程</span><i></i> </a> 
     
    <a href="article.php?id=9" class="clearfix"> <span>售后流程</span><i></i> </a> 
    ...
    <div class="pagenav-wrapper" id="J_PageNavWrap" style="">
      <div class="pagenav-content">
        <div class="pagenav" id="J_PageNav" style="display:flex; text-align:center;">
          ...
          <div class="p-prev"> 
                            <a href="article_cat.php?id=3&amp;page=1" >上一页</a>
                          </div>
          <div class="pagenav-cur">
            <div class="pagenav-text"> <span>2/2</span> <i></i> </div>
            <select name="page" class="pagenav-select" onchange="window.location.href=this.options[this.selectedIndex].value" >
              ...
              <option value="article_cat.php?id=3&amp;page=2">2</option>
                                    </select>
          </div>
